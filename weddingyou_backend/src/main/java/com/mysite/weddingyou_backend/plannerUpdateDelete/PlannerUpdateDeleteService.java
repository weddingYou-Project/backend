...
public class PlannerUpdateDeleteService {
	...
	public PlannerUpdateDelete login(PlannerUpdateDelete loginPlannner) {
		 ...
		 */
		PlannerUpdateDelete planner = plannerRepository.findByEmail(loginPlannner.getEmail());
		//optional 객체가 되는거임
	...
	public int sendTemporaryPassword(String email) {
	    ...
	    PlannerUpdateDelete optionalPlanner = plannerRepository.findByEmail(email);
